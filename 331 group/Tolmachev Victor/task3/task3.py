...
city.create_svgmap('tsp_nna_map.svg')
...
cycle, length = city.tsp_double_min_spanning_tree(origin, hospitals, tsp_path_matrix, tsp_edge_list)

print('DMTS distance:', length)
...
city.create_svgmap('tsp_dmts_map.svg')
